...
function App() {
  ...
  useEffect(()=>{fetch("https://fakestoreapi.com/products").then((res)=>{return res.json();}).then((listOfProducts)=>{setlistOfProducts(listOfProducts);SetfilteredCategory(listOfProducts);});},[]);
